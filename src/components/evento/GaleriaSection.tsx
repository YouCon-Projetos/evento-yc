...
/** Projetos reais da YouCon num anel 3D: gira sozinho, segue a rolagem e aceita arrastar. */
export function GaleriaSection({ galeria }: { galeria: NonNullable<EventoConfig["galeria"]> }) {
  return (
    <section className="relative overflow-hidden bg-section-alt py-10 md:py-16 lg:py-20">
      ...
      <CircularGallery items={galeria.itens} className="h-[360px] sm:h-[500px] lg:h-[540px]" />

      <div className="container relative mx-auto px-4 md:px-6">
        <p className="mt-6 text-center text-[11px] text-muted-foreground md:mt-8 md:text-xs">Arraste ou role a página para girar a galeria</p>
